...
import com.fromzerotohero.tamana.adapters.BoardItemAdapter
...
class MainActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSharedPreferences =
            this.getSharedPreferences(Constants.TASMANA_PREFERENCES, Context.MODE_PRIVATE)
        ...
        if (tokenUpdated) {
            ...
            FirebaseMessaging.getInstance()
                .token.addOnSuccessListener(this@MainActivity) { task ->
                    updateFCMToken(task)
                }
        }
